...
function easywic_update_notify () {
    ...
    <div class="error ewic-setupdate">
        <p><?php _e( 'We recommend you to enable plugin Auto Update so you will get the latest features and other important updates from <strong>'.EWIC_NAME.'</strong>.<br />Click <a href="#"><strong><span id="ewicdoautoupdate">here</span></strong></a> to enable Auto Update.', 'image-slider-widget' ); ?></p>
    </div>
